...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SAMPLE_CAN_BABBLING_CAN_ID, 0x010);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SAMPLE_CAN_BABBLING_TX_QUEUE_SIZE, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_H753ZI_STM32H753XX, 1);
